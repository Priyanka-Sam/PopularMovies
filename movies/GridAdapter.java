...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.MoviesGridViewHolder> {
    ...
    private final GridAdapterOnClickHandler mClickHandler;
    ...
    public GridAdapter(Context context, GridAdapterOnClickHandler listener) {
        mContext = context;
